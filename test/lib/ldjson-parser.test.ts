...
describe('json+ld parser', async () => {
    ...
    test('works for free article', async () => {
        const input = `{"@context":"http://schema.org","@type":"NewsArticle","mainEntityOfPage":{"@type":"WebPage","@id":"https%3A%2F%2Fwww.nzherald.co.nz%2Fnz%2Frowen-aupouri-death-mother-waiting-on-answers-after-sons-unexplained-death-in-hawkes-bay%2FDSCWIRHAHBGFNC6VLC5CAWILYQ%2F"},"publisher":{"@type":"NewsMediaOrganization","name":"NZ Herald","logo":{"@type":"ImageObject","url":"https://www.nzherald.co.nz/pb/resources/assets/icons/navigation/site-logo/png/nzh-logo.png"}},"author":[{"@type":"Person","name":"James Pocock","url":"https://s3.amazonaws.com/arc-authors/nzme/2dc792fe-9740-4af9-a6db-9ffed4a3d323.png"}],"datePublished":"2024-01-05T01:15:47.218Z","dateModified":"2024-01-05T01:15:48.056Z","headline":"Rowen Aupouri death: Mother waiting on answers after son’s ‘unexplained’ death in Hawke’s Bay","image":[{"@type":"ImageObject","url":"https://www.nzherald.co.nz/resizer/-FNvxbtletbRaTUBYjTuZ0sWwus=/arc-anglerfish-syd-prod-nzme/public/I6GPSGWY6RAOXKCWNMVML7DXLM.jpg"},{"@type":"ImageObject","url":"https://www.nzherald.co.nz/resizer/UYrF82d4wr0lYMBWK55z8zjoiio=/576x613/smart/filters:quality(70)/cloudfront-ap-southeast-2.images.arcpublishing.com/nzme/I6GPSGWY6RAOXKCWNMVML7DXLM.jpg"},{"@type":"ImageObject","url":"https://www.nzherald.co.nz/resizer/111IE1ivpil7rWVDf7gwNYIUhcM=/768x432/smart/filters:quality(70)/cloudfront-ap-southeast-2.images.arcpublishing.com/nzme/I6GPSGWY6RAOXKCWNMVML7DXLM.jpg"},{"@type":"ImageObject","url":"https://www.nzherald.co.nz/resizer/N0qIUuNTGzYhKPtsmRtqNNaWPq8=/992x558/smart/filters:quality(70)/cloudfront-ap-southeast-2.images.arcpublishing.com/nzme/I6GPSGWY6RAOXKCWNMVML7DXLM.jpg"},{"@type":"ImageObject","url":"https://www.nzherald.co.nz/resizer/4ZsBcyABDkwyo_dBNG4YgVCoZAA=/1440x810/smart/filters:quality(70)/cloudfront-ap-southeast-2.images.arcpublishing.com/nzme/I6GPSGWY6RAOXKCWNMVML7DXLM.jpg"}],"isPartOf":{"@type":["CreativeWork","Product"],"name":"nzherald.co.nz","productID":"nzherald.co.nz:NZHfourweekly"},"isAccessibleForFree":"true"}`;
        const parsed = await scrapeJsonLd(input);
        expect(parsed.urlAccess).to.be.undefined;
    })
